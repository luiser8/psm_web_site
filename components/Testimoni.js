    ...
    <>
      ...
      <div className="flex w-full items-center justify-end">
        <div className="flex flex-none justify-between w-auto mt-14">
          <div
            className="mx-4 flex items-center justify-center h-14 w-14 rounded-full bg-white border-orange-800 border hover:bg-orange-800 hover:text-white-500 transition-all text-orange-800 cursor-pointer"
            onClick={sliderRef?.slickPrev}
          >
            <ArrowBack className="h-6 w-6 " />
          </div>
          <div
            className="flex items-center justify-center h-14 w-14 rounded-full bg-white border-orange-800 border hover:bg-orange-800 hover:text-white-500 transition-all text-orange-800 cursor-pointer"
