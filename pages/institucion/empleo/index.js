...
import countryCodesMock from "../../../utils/mocks/countryCodesMock";
    ...
    return (
        <div className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
                <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Trabaja con nosotros</h2>
            ...
            <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
                <div className="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                    ...
                    <div className="sm:col-span-2">
                        ...
                        <div className="relative mt-2.5">
                            <div className="absolute inset-y-0 left-0 flex items-center">
                                ...
                                >
                                    {Object.keys(countryCodesMock).map((code, key) => (
                                        <option key={key}>{countryCodesMock[code].code} {countryCodesMock[code].dial_code}</option>
                                    ))}
                                </select>
                            </div>
                            <input
                    ...
                    <div className="col-span-full">
                        <label for="cover-cv" className="block text-sm font-medium leading-6 text-gray-900">Cargar curriculum</label>
                        <div className="mt-2 flex justify-center rounded-lg border border-solid border-blue-900/50 px-6 py-10">
