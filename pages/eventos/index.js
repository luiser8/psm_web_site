      ...
      <div className="max-w-screen py-12 px-6 sm:px-8 lg:px-16 mx-auto flex flex-col w-full text-center justify-center">
        <div className="flex flex-col w-full">
          ...
          <ScrollAnimationWrapper>
            ...
            >
              {eventosMock.map((eventosMock, index) => (
                <div className="p-4 md:w-1/3" key={index}>
                  <div className="h-full border-2 border-gray-500 rounded-lg overflow-hidden hover:border-orange-400 transition-all">
                    <img className="lg:h-full md:h-full w-full object-cover object-center" src={eventosMock.image} alt="image" />
                    <div className="p-6">
                      <h1 className="title-font text-lg font-medium text-gray-900 mb-3">{eventosMock.name}</h1>
                      <p className="leading-relaxed mb-3">{eventosMock.description}</p>
